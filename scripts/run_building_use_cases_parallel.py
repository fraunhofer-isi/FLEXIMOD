...
def annual_jobs(output_root: Path) -> list[Job]:
    specs = [
        ...
        ("I07d PV with high-load demand management", "building_v2b_pv_self_consumption_annual", "building_v2g_pv_cost_capped_high_load_relief", "v2g_pv_cost_capped_high_load_relief"),
