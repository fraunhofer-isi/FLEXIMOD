...
def annual_jobs(output_root: Path) -> list[Job]:
    specs = [
        ...
        ("I03 power-system peak-demand import reduction without export", "building_v2b_grid_support_annual", "building_v2b_grid_support_max_no_export", "grid_support_no_export"),
        ("I04 power-system peak-demand import reduction at 5 kW", "building_v2b_grid_support_annual", "building_v2g_grid_support_max_export_5kw", "grid_support_export_5kw"),
        ("I04 power-system peak-demand import reduction at 450 kW", "building_v2b_grid_support_annual", "building_v2g_grid_support_max_export_450kw", "grid_support_export_450kw"),
        ...
        ("I07b rooftop PV operation at current export policy", "building_v2b_pv_self_consumption_annual", "building_v2b_pv_self_consumption", "v2g_pv_current_policy"),
        ("I07c rooftop PV operation at viable export tariff", "building_v2b_pv_self_consumption_annual", "building_v2g_pv_export_viable_tariff", "v2g_pv_viable_tariff"),
        ("I07d PV with power-system peak-demand management", "building_v2b_pv_self_consumption_annual", "building_v2g_pv_cost_capped_high_load_relief", "v2g_pv_cost_capped_high_load_relief"),
